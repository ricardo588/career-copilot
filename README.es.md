...
- Generación privada y de sólo lectura de shortlists desde exportaciones JSON de vacantes, con validación de fuente seleccionada, frescura y URL canónica; nunca consulta un portal ni cambia un tracker
