...
12. Previsualiza una proyección sintética y local de tarjeta a Kanban de Obsidian sin escribir en un vault.
13. Registra que ocurrieron cero acciones externas.
...
- `kanban_projection.status` es `dry_run` y su decisión es `create_board_plan`.
